...
*-------------------------------------------------------------------
* $Id: codrv_canbittiming.c 1995 2012-12-13 12:24:54Z  $
*
*
*-------------------------------------------------------------------
*
...
CO_CONST CODRV_BTR_T codrvCanBittimingTable[] = {
		/* 50MHz table, prescaler 6bit (max 64) + +2bit more == 256 */
...
CO_CONST CODRV_BTR_T codrvCanBittimingTable[] = {
		/* 45MHz table, prescaler 6bit (max 64) + 2bit more == max. 256 */
# ifdef CODRV_CANCLOCK_PRE_10BIT
...
CO_CONST CODRV_BTR_T codrvCanBittimingTable[] = {
		/* 36MHz table, prescaler 8bit (max 256) */
# ifdef CODRV_CANCLOCK_PRE_10BIT
		{   10u,225u, 0, 13u, 2u }, 
...
CO_CONST CODRV_BTR_T codrvCanBittimingTable[] = {
		/* 20MHz table, prescaler 8bit (max 256) */
# ifdef CODRV_CANCLOCK_PRE_10BIT
		{    10u,125u, 0, 13u, 2u }, 
# endif
		{    20u, 50u, 0, 16u, 3u }, /* !! 85% */
...
CO_CONST CODRV_BTR_T codrvCanBittimingTable[] = {
		/* 16MHz table, prescaler 8bit (max 256) */
# ifdef CODRV_CANCLOCK_PRE_10BIT
		{    10u,100u, 0, 13u, 2u }, 
# endif
		{    20u, 50u, 0, 13u, 2u }, 
