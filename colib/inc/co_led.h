...
*
*-------------------------------------------------------------------
* $Id: co_led.h 10342 2015-08-24 13:53:52Z boe $
*-------------------------------------------------------------------
*
*
*
...
EXTERN_DECL RET_T coEventRegister_LED_GREEN(CO_EVENT_LED_T);
EXTERN_DECL RET_T coEventRegister_LED_RED(CO_EVENT_LED_T);
