...
*
*-------------------------------------------------------------------
* $Id: co_lss.h 10342 2015-08-24 13:53:52Z boe $
*
*-------------------------------------------------------------------
*
*
...
EXTERN_DECL RET_T coEventRegister_LSS(CO_EVENT_LSS_T); 
EXTERN_DECL RET_T coEventRegister_LSS_MASTER(CO_EVENT_LSS_MASTER_T);
